...
export function TrainingStoryReviewClient({
    ...
    async function handleSubmit(event: FormEvent<HTMLFormElement>) {
        ...
        try {
            let savedStory: TrainingStory;

            try {
                savedStory = await trainingStoryService.updateFullTrainingStory(
                    story.id,
                    updatedStory,
                    token
                );
            } catch {
                savedStory = await trainingStoryService.createFullTrainingStory(
                    updatedStory,
                    token
                );
            }
